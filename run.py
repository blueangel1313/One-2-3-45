...
def reconstruct(exp_dir, output_format=".glb", device_idx=0, resolution=256):
    ...
    bash_script = f'CUDA_VISIBLE_DEVICES={device_idx} python exp_runner_generic_blender_val.py --specific_dataset_name {exp_dir} --mode export_mesh --conf confs/one2345_lod0_val_demo.conf --resolution {resolution}'
    print(bash_script)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_format', type=str, default=".glb", help='Output format: .ply, .obj, .glb')
